...
function ProgressiveList(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, children.slice(0, visibleCount));
}
...
function getCompiledSubcomponents(id, compiledArray, contextProps, schemaProp, path, meta, isEditing, components) {
  ...
  if (!isEditing && elements.length > 3) {
    return /*#__PURE__*/React__default["default"].createElement(ProgressiveList, {
      initialCount: 3,
      batchSize: 2
    }, elements.map((el, i) => /*#__PURE__*/React__default["default"].isValidElement(el) ? el : /*#__PURE__*/React__default["default"].createElement(React.Fragment, {
      key: i
    }, el)));
  }
  return elements;
