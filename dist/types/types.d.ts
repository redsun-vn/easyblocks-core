...
export type ThemeFont = ResponsiveValue<{
    [key: string]: any;
}>;
...
export type StringSchemaProp = ValueSchemaProp<"string", string, "optional"> & SchemaPropParams<{
    normalize?: (x: string) => string | null;
}>;
export type NumberSchemaProp = ValueSchemaProp<"number", number, "optional"> & SchemaPropParams<{
    min?: number;
    max?: number;
}>;
...
export type SelectSchemaProp = ValueSchemaProp<"select", string, "optional"> & SchemaPropParams<{
    options: Option[];
}, true>;
export type RadioGroupSchemaProp = ValueSchemaProp<"radio-group", string, "optional"> & SchemaPropParams<{
    options: Option[];
}, true>;
/**
 ...
 */
export type ColorSchemaProp = ValueSchemaProp<"color", ResponsiveValue<TokenValue<Color>>, "forced">;
export type StringTokenSchemaProp = ValueSchemaProp<"stringToken", ResponsiveValue<TokenValue<string>>, "forced"> & SchemaPropParams<{
    tokenId: "numberOfItemsInRow" | "aspectRatios" | "containerWidths" | "boxShadows";
    extraValues?: Array<string | {
        value: string;
        label: string;
    }>;
}, true>;
export type SpaceSchemaProp = ValueSchemaProp<"space", ResponsiveValue<TokenValue<Spacing>>, "forced"> & SchemaPropParams<{
    prefix?: string;
    autoConstant?: number;
}>;
export type FontSchemaProp = ValueSchemaProp<"font", ResponsiveValue<TokenValue<Font>>, "forced">;
export type IconSchemaProp = ValueSchemaProp<"icon", TokenValue<string>, "never">;
...
export type TextSchemaProp = ValueSchemaProp<"text", LocalTextReference | ExternalReference | string, "never"> & {
    normalize?: (x: string) => string | null;
    [key: string]: any;
};
...
export type PositionSchemaProp = ValueSchemaProp<"position", ResponsiveValue<Position>, "forced">;
export type ExternalSchemaProp = ValueSchemaProp<string & Record<never, never>, ExternalReference, "optional"> & {
    params?: ExternalParams;
    optional?: boolean;
};
export type LocalSchemaProp = ValueSchemaProp<string & Record<never, never>, any, "optional">;
export type TokenSchemaProp = ValueSchemaProp<string & Record<never, never>, any, "forced"> & SchemaPropParams<{
    extraValues: Array<any | {
        value: any;
        label: string;
    }>;
}>;
export type SchemaProp = StringSchemaProp | NumberSchemaProp | BooleanSchemaProp | SelectSchemaProp | RadioGroupSchemaProp | ColorSchemaProp | SpaceSchemaProp | FontSchemaProp | StringTokenSchemaProp | IconSchemaProp | TextSchemaProp | ComponentSchemaProp | ComponentCollectionSchemaProp | ComponentCollectionLocalisedSchemaProp | PositionSchemaProp | ExternalSchemaProp | LocalSchemaProp | TokenSchemaProp;
export type AnyValueSchemaProp = StringSchemaProp | NumberSchemaProp | BooleanSchemaProp | SelectSchemaProp | RadioGroupSchemaProp | ColorSchemaProp | SpaceSchemaProp | FontSchemaProp | StringTokenSchemaProp | IconSchemaProp | TextSchemaProp | PositionSchemaProp | ExternalSchemaProp;
...
export type InlineTypeWidgetComponentProps<Type extends NonNullish = NonNullish> = {
    value: Type;
    onChange: (newValue: Type) => void;
    params?: Record<string, any>;
};
export type TokenTypeWidgetComponentProps<Type extends NonNullish = NonNullish> = InlineTypeWidgetComponentProps<Type>;
export type Widget = {
    id: string;
    label: string;
};
...
export type NoCodeComponentStylesFunctionInput<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = {
    values: Values;
    params: {
        $width: number;
        $widthAuto: boolean;
...
export type InferNoCodeComponentStylesFunctionInput<T> = T extends NoCodeComponentDefinition<infer Values, infer Params> ? NoCodeComponentStylesFunctionInput<Values, Params> : never;
...
export type NoCodeComponentStylesFunction<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = (input: NoCodeComponentStylesFunctionInput<Values, Params>) => NoCodeComponentStylesFunctionResult;
export type NoCodeComponentEditingFunctionInput<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = {
    values: Values;
    params: Params;
    editingInfo: EditingInfo;
    device: DeviceRange;
};
export type NoCodeComponentEditingFunction<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = (input: NoCodeComponentEditingFunctionInput<Values, Params>) => NoCodeComponentEditingFunctionResult;
export type NoCodeComponentAutoFunctionInput<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = {
    values: {
        [key in keyof Values]: ResponsiveValue<Values[key]>;
    };
    params: {
        [key in keyof Params]: ResponsiveValue<Params[key]>;
    };
    devices: Devices;
};
export type NoCodeComponentAutoFunction<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = (input: NoCodeComponentAutoFunctionInput<Values, Params> & {
    params: {
...
export type NoCodeComponentDefinition<Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = {
    id: string;
...
export type CustomTypeDefinition = InlineTypeDefinition | ExternalTypeDefinition | TokenTypeDefinition;
/**
 * Backend types
 */
...
export type SchemaPropShared<Type extends string> = {
    ...
    visible?: boolean | ((allValues: any, options: {
        editorContext: any;
    }) => boolean);
    description?: string;
    group?: string;
...
type ValueSchemaProp<Type extends string, ValueType, Responsiveness extends "optional" | "forced" | "never"> = SchemaPropShared<Type> & {
    ...
    buildOnly?: boolean;
    responsive?: Responsiveness extends "optional" ? boolean : Responsiveness extends "never" ? false : never;
};
export type SchemaPropParams<T extends Record<string, unknown>, Required extends boolean = false> = Required extends true ? {
    params: T;
} : {
    params?: T;
};
...
export type SerializedRenderableComponentDefinition = ComponentDefinitionShared & {
    pasteSlots?: Array<string>;
};
...
export type SerializedComponentDefinition = SerializedRenderableComponentDefinition | SerializedActionComponentDefinition | SerializedLinkComponentDefinition;
...
export type RenderableContent = EmptyRenderableContent | NonEmptyRenderableContent;
...
export interface Field<F extends Field = AnyField, SchemaPropValue extends SchemaProp = SchemaProp> {
...
export type CompiledComponentConfigBase<Identifier extends string = string, Props extends Record<string, any> = Record<string, any>> = {
    _component: Identifier;
    _id: string;
    props: Props;
};
...
export type CompilerModule = {
    compile: (content: NoCodeComponentEntry, config: Config, contextParams: ContextParams) => {
     ...
     */
    findExternals: (rawContent: any, config: Config, contextParams: ContextParams) => ExternalWithSchemaProp[];
...
type FetchResourceRejectedResult = {
    error: Error;
};
export type NonNullish = {};
export type FetchResourceResult<T extends NonNullish = NonNullish> = FetchResourceResolvedResult<T> | FetchResourceRejectedResult;
export type FetchOutputBasicResources = Record<string, FetchResourceResult>;
export type FetchCompoundResourceResultValue<Type extends string = string, Value extends NonNullish = NonNullish> = {
    type: Type;
    value: Value;
    label?: string;
};
export type FetchCompoundTextResourceResultValue = FetchCompoundResourceResultValue<"text", string>;
export type FetchCompoundResourceResultValues = Record<string, FetchCompoundTextResourceResultValue | FetchCompoundResourceResultValue<string & Record<never, never>, NonNullish>>;
...
export type FetchOutputCompoundResources = Record<string, ExternalDataCompoundResourceResolvedResult | ExternalDataCompoundResourceRejectedResult>;
export type FetchOutputResources = Record<string, (FetchOutputBasicResources | FetchOutputCompoundResources)[string]>;
...
export type ExternalData = Record<string, (FetchOutputBasicResources | FetchOutputCompoundResources)[string]>;
export type LocalReference<Value = unknown> = {
    id: string;
    value: Value;
    widgetId: string;
};
export type LocalTextReference = Omit<LocalReference<LocalizedText>, "id" | "widgetId"> & {
    id: `local.${string}`;
    widgetId: "@easyblocks/local-text";
};
export type CompiledLocalTextReference = Omit<LocalReference<string>, "id" | "widgetId"> & {
    id: `local.${string}`;
    widgetId: "@easyblocks/local-text";
};
...
export type ExternalReferenceNonEmpty<Identifier extends NonNullish = NonNullish> = {
    id: Identifier;
    widgetId: string;
    key?: string;
};
export type ExternalReference<Identifier extends NonNullish = NonNullish> = ExternalReferenceEmpty | ExternalReferenceNonEmpty<Identifier>;
