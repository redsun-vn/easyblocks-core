 ...
 * printing it.
 */
export declare function mockConsoleMethod(method: "log" | "warn" | "error" | "info"): {
    calls: unknown[][];
    mockedFn: jest.SpyInstance<void, [message?: any, ...optionalParams: any[]] | [message?: any, ...optionalParams: any[]] | [message?: any, ...optionalParams: any[]] | [message?: any, ...optionalParams: any[]]>;
    unmock: () => void;
};
//# sourceMappingURL=testUtils.console.d.ts.map