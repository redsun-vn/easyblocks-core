...
export { compile, compileInternal, createCompilationContext, findExternals, getSchemaDefinition, mergeCompilationMeta, normalize, normalizeInput, validate, } from "./compiler";
export type { CompilationCache, CompilationCacheItemValue, SchemaPropDefinitionProviders, TemplateQueryType, TGlobalSectionChange, } from "./compiler";
