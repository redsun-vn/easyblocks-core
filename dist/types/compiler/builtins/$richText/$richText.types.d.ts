...
import { NoCodeComponentEntry, NoCodeComponentEditingFunctionInput, NoCodeComponentEditingFunctionResult } from "../../../types";
...
declare module "slate" {
    interface CustomTypes {
        ...
        Element: BulletedList | ListItemElement | NumberedList | ParagraphElement | TextLineElement;
        Text: Text;
    }
}
export type RichTextEditingFunction = (input: NoCodeComponentEditingFunctionInput & {
