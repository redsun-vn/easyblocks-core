...
export type CompilationContextCustomTypeDefinition = InlineTypeDefinition | SetRequired<ExternalTypeDefinition, "widgets"> | TokenTypeDefinition;
...
export type EditableComponentToComponentConfig<EditableComponent extends {
    id: string;
    label?: string;
    type?: string | string[];
    schema: Array<SchemaProp>;
}> = ComponentConfigBase<EditableComponent["id"]>;
export type CompiledNoCodeComponentProps<Identifier extends string = string, StateProps extends Record<string, any> = Record<string, any>, ContextProps extends Record<string, any> = Record<string, any>, Styles extends Record<string, unknown> = Record<string, unknown>> = {
...
export type InternalEditingFunctionResult = {
    ...
    components?: {
        [field: string]: PartialDeep<EditingInfoComponent | EditingInfoComponentCollection>;
    };
};
export type ContextProps = Record<string, any>;
export type InternalRenderableComponentDefinition<Identifier extends string = string, Values extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> = ComponentDefinitionShared<Identifier> & {
    pasteSlots?: string[];
