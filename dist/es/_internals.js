...
import { b as cleanString, B as Box, R as RichTextPartClient, C as ComponentBuilder } from './ComponentBuilder-a540c049.js';
export { C as ComponentBuilder, E as EasyblocksMetadataProvider, f as componentPickerClosed, g as componentPickerOpened, i as itemInserted, h as itemMoved, j as richTextChangedEvent, s as selectionFramePositionChanged, u as useEasyblocksMetadata } from './ComponentBuilder-a540c049.js';
...
function useTextValue(value, onChange, locale, locales, defaultPlaceholder, normalize) {
  ...
  // there.
  const hasOwnValue = isExternal ? typeof value.value?.[locale] === "string" : value !== undefined && value !== null;
  const style = {
