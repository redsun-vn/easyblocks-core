...
function traverseComponentsInternal(componentConfig, context, callback, path) {
  ...
  componentDefinition.schema.forEach(schemaProp => {
    if (isSchemaPropComponent(schemaProp) || schemaProp.type === "component-collection") ; else if (schemaProp.type === "component-collection-localised") {
      for (const locale in componentConfig[schemaProp.prop]) {
        if (locale !== "__localized") {
          console.log("locale: ", locale);
          console.log("componentConfig: ", componentConfig);
          console.log("schemaProp: ", schemaProp);
          console.log("componentConfig[schemaProp.prop][locale]: ", componentConfig[schemaProp.prop][locale]);
...
export { responsiveValueAt as $, isNonEmptyRenderableContent as A, isEmptyRenderableContent as B, ComponentBuilder as C, isLocalValue as D, EasyblocksMetadataProvider as E, CompilationCache as F, getSchemaDefinition as G, EasyblocksBackend as H, getDefaultLocale as I, getFallbackLocaleForLocale as J, getFallbackForLocale as K, getExternalValue as L, getResolvedExternalDataValue as M, resolveExternalValue as N, isCompoundExternalDataValue as O, responsiveValueFill as P, responsiveValueFindHigherDeviceWithDefinedValue as Q, RichTextPartClient as R, responsiveValueFindLowerDeviceWithDefinedValue as S, responsiveValueFindDeviceWithDefinedValue as T, responsiveValueGet as U, responsiveValueForceGet$1 as V, responsiveValueGetFirstHigherValue as W, responsiveValueGetFirstLowerValue as X, responsiveValueGetDefinedValue as Y, responsiveValueMap as Z, responsiveValueFlatten as _, isDocument as a, responsiveValueValues as a0, responsiveValueReduce as a1, responsiveValueNormalize$1 as a2, responsiveValueGetHighestDefinedDevice as a3, deepClone as a4, traverseComponents as a5, uniqueId as a6, buildRichTextBlockElementComponentConfig as a7, buildRichTextLineElementComponentConfig as a8, buildRichTextPartComponentConfig as a9, itemMoved as aA, richTextChangedEvent as aB, selectionFramePositionChanged as aC, buildRichTextBulletedListBlockElementComponentConfig as aD, buildRichTextComponentConfig as aE, buildRichTextParagraphBlockElementComponentConfig as aF, nonNullable as aa, deepCompare as ab, dotNotationGet as ac, dotNotationSet as ad, compileBox as ae, getBoxStyles as af, Box as ag, textStyles as ah, findComponentDefinition as ai, findComponentDefinitionById as aj, scalarizeConfig$1 as ak, useEasyblocksMetadata as al, stripRichTextPartSelection as am, parsePath as an, findPathOfFirstAncestorOfType as ao, isSchemaPropComponentCollectionLocalised as ap, isSchemaPropCollection as aq, isSchemaPropComponent as ar, isSchemaPropComponentOrComponentCollection as as, isSchemaPropActionTextModifier as at, isSchemaPropTextModifier as au, isCustomSchemaProp as av, textModifierSchemaProp as aw, componentPickerClosed as ax, componentPickerOpened as ay, itemInserted as az, isComponentConfig as b, createCompilationContext as c, compileInternal as d, configTraverse as e, isLocalTextReference as f, isExternalSchemaProp as g, getExternalReferenceLocationKey as h, isTrulyResponsiveValue$1 as i, cleanString as j, EasyblocksExternalDataProvider as k, buildRichTextNoCodeEntry as l, resolveLocalisedValue as m, normalize as n, getDevicesWidths as o, easyblocksGetCssText as p, easyblocksGetStyleTag as q, responsiveValueEntries as r, serialize as s, parseSpacing as t, spacingToPx as u, validateColor as v, isResolvedCompoundExternalDataValue as w, isIdReferenceToDocumentExternalValue as x, isEmptyExternalReference as y, isRenderableContent as z };
