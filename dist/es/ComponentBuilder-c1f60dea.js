...
function flattenItemProps(config, componentDefinition, collectionSchemaProp, itemsSchemas) {
  ...
  const itemProps = Object.fromEntries(itemsSchemas.map(itemSchemaProp => {
    const value = collectionItemProps?.[itemSchemaProp.prop];
    if (value === undefined && "defaultValue" in itemSchemaProp) {
      return [itemSchemaProp.prop, itemSchemaProp.defaultValue];
    }
    return [itemSchemaProp.prop, value];
  }));
  return itemProps;
}
...
export { responsiveValueReduce as $, validateColor as A, easyblocksGetCssText as B, ComponentBuilder as C, easyblocksGetStyleTag as D, EasyblocksMetadataProvider as E, getDefaultLocale as F, getFallbackForLocale as G, getFallbackLocaleForLocale as H, getExternalValue as I, getResolvedExternalDataValue as J, isCompoundExternalDataValue as K, resolveExternalValue as L, responsiveValueAt as M, responsiveValueFill as N, responsiveValueFindDeviceWithDefinedValue as O, responsiveValueFindHigherDeviceWithDefinedValue as P, responsiveValueFindLowerDeviceWithDefinedValue as Q, RichTextPartClient as R, responsiveValueFlatten as S, responsiveValueForceGet$1 as T, responsiveValueGet as U, responsiveValueGetDefinedValue as V, responsiveValueGetFirstHigherValue as W, responsiveValueGetFirstLowerValue as X, responsiveValueGetHighestDefinedDevice as Y, responsiveValueMap as Z, responsiveValueNormalize$1 as _, isDocument as a, responsiveValueValues as a0, parseSpacing as a1, spacingToPx as a2, deepClone as a3, traverseComponents as a4, uniqueId as a5, buildRichTextBlockElementComponentConfig as a6, buildRichTextLineElementComponentConfig as a7, buildRichTextPartComponentConfig as a8, nonNullable as a9, richTextChangedEvent as aA, selectionFramePositionChanged as aB, buildRichTextBulletedListBlockElementComponentConfig as aC, buildRichTextComponentConfig as aD, buildRichTextParagraphBlockElementComponentConfig as aE, deepCompare as aa, dotNotationGet as ab, dotNotationSet as ac, compileBox as ad, getBoxStyles as ae, Box as af, textStyles as ag, findComponentDefinition as ah, findComponentDefinitionById as ai, scalarizeConfig$1 as aj, useEasyblocksMetadata as ak, stripRichTextPartSelection as al, parsePath as am, findPathOfFirstAncestorOfType as an, isSchemaPropComponentCollectionLocalised as ao, isSchemaPropCollection as ap, isSchemaPropComponent as aq, isSchemaPropComponentOrComponentCollection as ar, isSchemaPropActionTextModifier as as, isSchemaPropTextModifier as at, isCustomSchemaProp as au, textModifierSchemaProp as av, componentPickerClosed as aw, componentPickerOpened as ax, itemInserted as ay, itemMoved as az, isComponentConfig as b, createCompilationContext as c, compileInternal as d, configTraverse as e, isLocalTextReference as f, isExternalSchemaProp as g, getExternalReferenceLocationKey as h, isTrulyResponsiveValue$1 as i, cleanString as j, EasyblocksExternalDataProvider as k, isEmptyExternalReference as l, isEmptyRenderableContent as m, normalize as n, isIdReferenceToDocumentExternalValue as o, isLocalValue as p, isNonEmptyRenderableContent as q, responsiveValueEntries as r, serialize as s, isRenderableContent as t, isResolvedCompoundExternalDataValue as u, CompilationCache as v, getSchemaDefinition as w, buildRichTextNoCodeEntry as x, resolveLocalisedValue as y, getDevicesWidths as z };
